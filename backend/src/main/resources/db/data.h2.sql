...
(43, 'GVoS: A General System for Near-Duplicate Video-Related Applications on Storm', DATE '2019-04-11', 'ACM Trans. Inf. Syst.', '1', '36', 0, 0, '3:1--3:36', 0.0, 'jun', 2017, 'ACM', 'Jiang:2017:GGS:3077622.3041657', 'GVoS: A General System for Near-Duplicate Video-Related Applications on Storm', 'http://doi.acm.org/10.1145/3041657', 7, 2),
(54, 'Interactive Public Ambient Displays: Transitioning from Implicit to Explicit, Public to Personal, Interaction with Multiple Users', DATE '2019-04-11', 'Proceedings of the 17th Annual ACM Symposium on User Interface Software and Technology', NULL, NULL, 0, 0, '137--146', 0.0, NULL, 2004, 'ACM', 'Vogel:2004:IPA:1029632.1029656', 'Interactive Public Ambient Displays: Transitioning from Implicit to Explicit, Public to Personal, Interaction with Multiple Users', 'http://doi.acm.org/10.1145/1029632.1029656', 6, 2);
