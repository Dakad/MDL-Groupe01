;              
CREATE USER IF NOT EXISTS SA SALT '30d5dbdc16732990' HASH '2b8fb0f93309bfe8831872332771b3fdd56266943f684fb2aafa994ff6095986' ADMIN;            
CREATE SEQUENCE PUBLIC.HIBERNATE_SEQUENCE START WITH 61;       
...
-- 7 +/- SELECT COUNT(*) FROM PUBLIC.ARTICLE;  
...
-- 24 +/- SELECT COUNT(*) FROM PUBLIC.ARTICLE_AUTHORS;         
...
-- 26 +/- SELECT COUNT(*) FROM PUBLIC.ARTICLE_KEYWORDS;        
...
-- 24 +/- SELECT COUNT(*) FROM PUBLIC.AUTHOR;  
...
-- 27 +/- SELECT COUNT(*) FROM PUBLIC.TAG;     
