...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.STATE_OF_THE_ART_TAGS;
...
ALTER TABLE PUBLIC.USER_GROUP ADD CONSTRAINT PUBLIC.CONSTRAINT_C PRIMARY KEY(USER_ID);
...
ALTER TABLE PUBLIC.BOOKMARK ADD CONSTRAINT PUBLIC.FKCOW5UX3YHMJ8UWU36SO5928GP FOREIGN KEY(ARTICLE_ID) REFERENCES PUBLIC.ARTICLE(ID) NOCHECK;
...
ALTER TABLE PUBLIC.BOOKMARK ADD CONSTRAINT PUBLIC.FK74S6INJEO6TRQCM8G2RPRI5BI FOREIGN KEY(SOTA_ID) REFERENCES PUBLIC.STATE_OF_THE_ART(ID) NOCHECK;
