...
ALTER TABLE PUBLIC.USER_PROFILE ADD CONSTRAINT PUBLIC.CONSTRAINT_EE PRIMARY KEY(ID);
...
ALTER TABLE PUBLIC.USER ADD CONSTRAINT PUBLIC.FKIF0O9AXOT4QWP3HQLVGEJ94RU FOREIGN KEY(PROFIL_ID) REFERENCES PUBLIC.USER_PROFILE(ID) NOCHECK;
...
ALTER TABLE PUBLIC.USER_PROFILE ADD CONSTRAINT PUBLIC.FKANMBAB87G3G6B3N155W3K4E0V FOREIGN KEY(USER_ID) REFERENCES PUBLIC.USER(ID) NOCHECK;
