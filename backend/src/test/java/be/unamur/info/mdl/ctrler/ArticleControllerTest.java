...
public class ArticleControllerTest {
  ...
  public void get_article_without_reference() throws Exception {
    api.perform(MockMvcRequestBuilders.get(GET_ARTICLE_URL + "/")
  ...
  public void get_article_with_invalid_reference() throws Exception {
    ...
    api.perform(MockMvcRequestBuilders.get(GET_ARTICLE_URL + "/invalid")
      .accept(MediaType.APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON))
      .andExpect(status().isNotFound());

    api.perform(MockMvcRequestBuilders.get(GET_ARTICLE_URL + "/article123")
      .accept(MediaType.APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON))
      .andExpect(status().isNotFound());
  }
  ...
  public void get_article_with_valid_reference() throws Exception {
    ...
    api.perform(MockMvcRequestBuilders.get(GET_ARTICLE_URL + "/rebolj1999gis")
      .accept(MediaType.APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON))
